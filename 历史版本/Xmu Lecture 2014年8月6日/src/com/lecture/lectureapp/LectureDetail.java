...
public class LectureDetail extends Activity {
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		linearBtnComment.setOnClickListener(new View.OnClickListener() {
			public void onClick(View v) {
				...
				Intent intent = new Intent(LectureDetail.this,
						CommentView.class);
				intent.putExtras(detail_bundle);
				
				//LectureDetail.this.startActivity(intent);
				LectureDetail.this.startActivityForResult( intent, 1 );
			}
		});
		...
		linearBtnLike.setOnClickListener(new View.OnClickListener() {
			public void onClick(View v) {
				...
				if (event.isLike()) {
					...
					DBCenter.setLike(
							DBCenter.getStaticDBCenter(LectureDetail.this)
		...
		*/
		/*
		 * //下面开始添加评论 edited by 咸鱼 2014年8月5日 晚 20:20 detailMyadapter = new
		 * DetailMyadapter(LectureDetail.this, mDataComments);
		 * 
		 * 
		 * commentListView = (ListView)findViewById(R.id.detailList_view);
		 * commentListView.setAdapter(detailMyadapter);
		 * 
		 * refreshableView_comment =
		 * (DetailRefreshableView)findViewById(R.id.detailRefreshable_view);
		 * refreshableView_comment.setOnRefreshListener(new
		 * DetailPullToRefreshListener() {
		 * 
	...
	public void setComments(List<Comment> commentsList) {
		...
		if(commentsList.size() == 0){
			...
			//提醒第一个沙发
			commentsBox.addView( new FootItemLinearLayout(LectureDetail.this) );
			
		}
		else{
			
			FootItemLinearLayout footItemLinearLayout = new FootItemLinearLayout(LectureDetail.this);
